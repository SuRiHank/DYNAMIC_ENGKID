...
<script
	...
	<style>
		h1 {
			color: #ff6600; /* Màu chữ (ví dụ: cam) */
			text-shadow: 2px 2px 5px rgba(0, 0, 0, 0.3); /* Tạo bóng cho chữ */
					...
					<div class="item">
						<div class="container">
							<div class="row">
								...
								<div class="span6">
									<img src="${pageContext.request.contextPath}/resources/file/images/slide/${list.getSlideimage()}.jpg"
										 onerror="this.onerror=null; this.src='${pageContext.request.contextPath}/resources/file/images/slide/${list.getSlideimage()}.png';">
								</div>
  ...
  ==============================================-->
		...
		<div class="row feature-box">
			...
			<div class="span4">
				...
				<h2>Ôn tập, ghi nhớ</h2>
				<p>Các bộ câu hỏi để ôn tập và ghi nhớ kiến thức.</p>
		...
		<div class="row">
			...
			<div class="span4">
				...
				<p align="justify">Mỗi năm, có hàng nghìn lượt Trẻ em đã tham
					dự các khóa học tiếng Anh tại đây và đạt kết quả như ý muốn. Chúng
					tôi tự hào là một trong những trung tâm ngoại ngữ được yêu thích,
					là địa chỉ tin cậy của các bé từ 3 -12 tuổi cũng như bạn nhỏ mới học tiếng anh,
					và nhiều bạn nhỏ khác trên toàn thế giới.</p>
