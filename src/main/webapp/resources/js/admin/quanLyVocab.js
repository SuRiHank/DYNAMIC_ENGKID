...
//////////////////////////////////////		
		...
		$.ajax({
				...
				type:'POST',
				url:"http://localhost:8080/webengkid/api/admin/vocab/save",
	...
	$('#updateVocab').click(function() {
		...
		data: formData,
		type:'POST',
		url:"http://localhost:8080/webengkid/api/admin/vocab/update",
		enctype : 'multipart/form-data',
	    contentType : false,
	    cache : false,
	    processData : false,
	...
	$(document).on('click','.editBaiVocab',function(e){
		 ...
		 idBaiVocab = fields[1];
          ...
          $.ajax({
  			type:'GET',
  			url:"http://localhost:8080/webengkid/api/admin/vocab/infoVocab/"+idBaiVocab,
  			success: function(data){
		...
		if(confirm("Bạn muốn xóa bài từ vựng này?"))
			{
				$.ajax({
					type:'POST',
					url:"http://localhost:8080/webengkid/api/admin/vocab/delete/"+idBaiVocab,
	...
	function loadAllVocab(){
		...
		$.ajax({
			dataType : 'json',
			type:'GET',
			url:"http://localhost:8080/webengkid/api/admin/vocab/loadVocab",
