$(document).ready(function() {
	...
	$('#btnAddNewExam').click(function() {
		...
		$.ajax({
				...
				type:'POST',
				url:"http://localhost:8080/webengkid/api/admin/exam/save",
	...
	$('#btnUpdateExam').click(function() {
		...
		data: formData,
		type:'POST',
		url:"http://localhost:8080/webengkid/api/admin/exam/update",
		enctype : 'multipart/form-data',
	    contentType : false,
	    cache : false,
	    processData : false,
	...
	$(document).on('click','.editBaiThiThu',function(e){
		 ...
		 idBaiThiThu = fields[1];
          ...
          $.ajax({
  			type:'GET',
  			url:"http://localhost:8080/webengkid/api/admin/exam/infoExam/"+idBaiThiThu,
  			success: function(data){
		...
		if(confirm("Bạn muốn xóa bài thi thử này?"))
			{
				...
				$.ajax({
					type:'POST',
					url:"http://localhost:8080/webengkid/api/admin/exam/delete/"+idBaiThiThu,
	...
	function loadAllBaiThiThu(){
		...
		$.ajax({
			dataType : 'json',
			type:'GET',
			url:"http://localhost:8080/webengkid/api/admin/exam/loadExam",
