$(document).ready(function() {
	...
	function ajaxGet(page){		
		...
		$.ajax({
			...
			url: "http://localhost:8080/webengkid/api/admin/tai-khoan/all" + '?page=' + page,
...
//					                  '<td><button class="btn btn-primary btnCapNhat" >Cập nhật</button></td>' + 
    ...
    function ajaxPostTaiKhoan() {    	
    	...
    	console.log(data);
    	 ...
    	 $.ajax({
 			...
 			type : "POST",
 			contentType : "application/json",
 			url : "http://localhost:8080/webengkid/api/admin/tai-khoan/save",
    ...
    $(document).on("click",".btnXoa", function() {
		...
		if(confirmation){
		  $.ajax({
			  type : "DELETE",
			  url : "http://localhost:8080/webengkid/api/admin/tai-khoan/delete/" + taiKhoanId,
