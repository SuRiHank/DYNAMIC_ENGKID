...
//	console.log("id="+examId);
	...
	var url="http://localhost:8080/webengkid/saveResultUser/"+examId+"/"+correctListening+"/"+correctReading;
...
function clickResutlReading(){
	...
	var url="http://localhost:8080/webengkid/showResultReading/"+examId+"/"+countCorrect;
	if(window.XMLHttpRequest){
		xhttp = new XMLHttpRequest();
	}
	else{
